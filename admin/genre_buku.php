<?php 
  ...
  if (isset($_POST['btnUbahGenre'])) {
    if (ubahGenre($_POST) > 0) {
      ...
      header("Location: genre_buku.php");
    }
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm">
            <h1 class="m-0 text-dark">Genre Buku</h1>
          </div><!-- /.col -->
                  ...
                  <?php foreach ($genre as $dg): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="hapus_genre_buku.php?id_genre=<?= $dg['id_genre']; ?>" data-nama="Genre Buku: <?= $dg['nama_genre']; ?>" class="btn-hapus btn btn-sm btn-danger"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
